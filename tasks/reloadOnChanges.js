...
/*
 * When any piece file is changed in the bot (e.g. when you `git pull`, or just edit a file), this
 * piece will automatically reload that piece so the change is instantly updated into the bot.
 */
...
module.exports = class extends Task {
  ...
  async init() {
    ...
    this.client._fileChangeWatcher = watch(process.cwd(), {
      ignored: ['**/node_modules/**/*', '**/bwd/provider/**/*'],
      persistent: true,
      ignoreInitial: true,
      cwd: process.cwd(),
    });
