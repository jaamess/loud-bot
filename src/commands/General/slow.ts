...
import parseTime from 'duration-parser';

export default class extends Command {
  constructor(store: CommandStore, file: string[], directory) {
  ...
  async run(message: KlasaMessage, [channel, duration]: [TextChannel, string[]]) {
